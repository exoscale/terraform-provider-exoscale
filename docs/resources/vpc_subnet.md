...
subcategory: ""
description: |-
  Manage Exoscale VPC https://community.exoscale.com/product/networking/vpc/ Subnets.
...
- `ipv4_block` (String) ❗ The Subnet IPv4 CIDR (e.g. `10.0.0.0/24`). Automatically allocated by the platform if not set.
